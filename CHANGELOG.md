...
- Update the Go compiler from v1.25.4 to v1.25.5 ([#4362](https://github.com/evanw/esbuild/issues/4362))
...
- Fix another TypeScript parsing edge case ([#4248](https://github.com/evanw/esbuild/issues/4248))
  ...
  class CachedDict {
  	...
  	has = window ? (word: string): boolean => this.#has(word) : this.#has;
  }
  ```
