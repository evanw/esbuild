...
func TestMangleIf(t *testing.T) {
	...
	expectPrintedMangle(t, "if (!!a || !!b) throw 0", "if (a || b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (!!a && !!b) throw 0", "if (a && b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (!!a ? !!b : !!c) throw 0", "if (a ? b : c)\n  throw 0;\n")

	expectPrintedMangle(t, "if ((a + b) !== 0) throw 0", "if (a + b !== 0)\n  throw 0;\n")
	expectPrintedMangle(t, "if ((a | b) !== 0) throw 0", "if (a | b)\n  throw 0;\n")
	expectPrintedMangle(t, "if ((a & b) !== 0) throw 0", "if (a & b)\n  throw 0;\n")
	expectPrintedMangle(t, "if ((a ^ b) !== 0) throw 0", "if (a ^ b)\n  throw 0;\n")
	expectPrintedMangle(t, "if ((a << b) !== 0) throw 0", "if (a << b)\n  throw 0;\n")
	expectPrintedMangle(t, "if ((a >> b) !== 0) throw 0", "if (a >> b)\n  throw 0;\n")
	expectPrintedMangle(t, "if ((a >>> b) !== 0) throw 0", "if (a >>> b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (+a !== 0) throw 0", "if (+a != 0)\n  throw 0;\n")
	expectPrintedMangle(t, "if (~a !== 0) throw 0", "if (~a)\n  throw 0;\n")

	expectPrintedMangle(t, "if (0 != (a + b)) throw 0", "if (a + b != 0)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != (a | b)) throw 0", "if (a | b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != (a & b)) throw 0", "if (a & b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != (a ^ b)) throw 0", "if (a ^ b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != (a << b)) throw 0", "if (a << b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != (a >> b)) throw 0", "if (a >> b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != (a >>> b)) throw 0", "if (a >>> b)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != +a) throw 0", "if (+a != 0)\n  throw 0;\n")
	expectPrintedMangle(t, "if (0 != ~a) throw 0", "if (~a)\n  throw 0;\n")
