...
var splittingSuiteCJS = suite{
	name: "splitting_cjs",
}

func TestSplittingSharedES6IntoCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
...
func TestSplittingAssignToLocalCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
...
func TestSplittingSideEffectsWithoutDependenciesCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
...
func TestSplittingNestedDirectoriesCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
...
func TestSplittingCircularReferenceIssue251CJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
				export * from './b.js';
...
func TestSplittingMissingLazyExportCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
...
func TestSplittingReExportIssue273CJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
				export const a = 1
...
func TestSplittingDynamicImportIssue272CJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
				import('./b')
...
func TestSplittingDynamicImportOutsideSourceTreeIssue264CJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
...
func TestSplittingCrossChunkAssignmentDependenciesCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
...
func TestSplittingCrossChunkAssignmentDependenciesRecursiveCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
				import { setX } from './x'
...
func TestSplittingDuplicateChunkCollisionCJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
				import "./ab"
...
func TestSplittingMinifyIdentifiersCrashIssue437CJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
...
func TestSplittingHybridESMAndCJSIssue617CJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
				export let foo
...
func TestSplittingHybridCJSAndESMIssue617CJS(t *testing.T) {
	splittingSuiteCJS.expectBundled(t, bundled{
		files: map[string]string{
			"/a.js": `
				export let foo
