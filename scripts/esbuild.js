...
exports.installForTests = () => {
  ...
  childProcess.execSync(`npm install --silent --prefer-offline  --no-audit --no-optional --ignore-scripts=false --progress=false esbuild-${version}.tgz`, { cwd: installDir, env, stdio: 'inherit' })
