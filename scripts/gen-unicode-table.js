...
const idStartESNext = require('@unicode/unicode-14.0.0/Binary_Property/ID_Start/code-points');
...
const idContinueESNext = require('@unicode/unicode-14.0.0/Binary_Property/ID_Continue/code-points');
